 ...
 */
/**
 * Official brand marks (Simple Icons paths, 24x24 viewBox) rendered inline so
 * there are no third-party requests and the logos stay crisp at any size.
 * Brand colours are used at rest; each is the platform's own registered mark.
 */
const BRAND_ICONS: Record<string, { path: string; colour: string }> = {
  Google: {
    colour: '#4285F4',
  ...
  Akamai: {
    colour: '#0096D6',
    path: 'M11.996 0C5.373 0 0 5.373 0 11.996c0 6.622 5.373 11.995 11.996 11.995 6.622 0 11.995-5.373 11.995-11.995C23.991 5.373 18.618 0 11.996 0zm0 1.895c5.578 0 10.1 4.522 10.1 10.101 0 5.578-4.522 10.1-10.1 10.1-5.579 0-10.101-4.522-10.101-10.1 0-5.579 4.522-10.101 10.1-10.101zm-.155 2.53c-4.02 0-7.288 3.243-7.288 7.245 0 1.76.632 3.375 1.68 4.638l1.35-1.35a5.412 5.412 0 01-1.116-3.288c0-2.99 2.42-5.418 5.4-5.418 1.243 0 2.39.42 3.305 1.126l1.35-1.35a7.226 7.226 0 00-4.681-1.703z',
  },
  Microsoft: {
    colour: '#5E5E5E',
  ...
  Meta: {
    colour: '#0081FB',
    path: 'M6.915 4.03c-1.968 0-3.683 1.28-4.871 3.113C.704 9.208 0 11.883 0 14.449c0 .706.07 1.369.21 1.973a6.624 6.624 0 00.265.86 5.297 5.297 0 00.371.761c.696 1.159 1.818 1.927 3.593 1.927 1.497 0 2.633-.671 3.965-2.444.76-1.012 1.144-1.626 2.663-4.32l.756-1.339.186-.325c.061.1.121.196.183.3l2.152 3.595c.724 1.21 1.665 2.556 2.47 3.314 1.046.987 1.992 1.22 3.06 1.22 1.075 0 1.876-.355 2.455-.843a3.743 3.743 0 00.81-.973c.542-.939.861-2.127.861-3.745 0-2.72-.681-5.357-2.084-7.45-1.282-1.912-2.957-2.93-4.716-2.93-1.047 0-2.088.467-3.053 1.308-.652.57-1.257 1.29-1.82 2.05-.69-.875-1.335-1.547-1.958-2.056-1.182-.966-2.315-1.303-3.454-1.303zm10.16 2.053c1.147 0 2.188.758 2.992 1.999 1.001 1.548 1.492 3.895 1.492 6.146 0 1.31-.204 2.335-.674 2.997-.301.423-.686.629-1.291.629-.556 0-1.052-.238-1.585-.755-.53-.514-1.13-1.334-1.855-2.54l-1.15-1.921-.161-.271a99.99 99.99 0 01-1.409-2.404c.63-.977 1.187-1.703 1.71-2.216.634-.62 1.169-.855 1.931-.855zm-10.16 2.11c.598 0 1.084.208 1.598.658.512.446 1.062 1.15 1.686 2.113l.062.096-.55.972c-1.417 2.51-1.77 3.076-2.4 3.916-.795 1.058-1.297 1.32-1.921 1.32-.606 0-1.155-.276-1.51-.869-.253-.42-.421-1.02-.421-1.907 0-2.11.581-4.35 1.481-5.74.663-1.02 1.402-1.559 2.375-1.559z',
  },
  Amazon: {
    colour: '#FF9900',
    path: 'M16.5088 16.8447c.1475-.5068.0908-.9736-.1553-1.3154-.2246-.3164-.6045-.499-1.0615-.5205l-8.6592-.1123a.1745.1745 0 01-.1416-.0723c-.0303-.0459-.0361-.1035-.0225-.1572.0264-.0947.1123-.1631.207-.1719l8.7412-.1123c1.0361-.0479 2.1592-.8877 2.5527-1.9160l.499-1.3013c.0215-.0566.0293-.1152.0186-.1729-.5654-2.5527-2.8398-4.457-5.5586-4.457-2.5049 0-4.6318 1.6172-5.3945 3.8623-.4932-.3682-1.1206-.5654-1.7959-.499-1.3486.1338-2.4287 1.2139-2.5625 2.5625-.0342.3486-.0078.6855.0693 1.0029C1.0684 13.6738 0 14.8770 0 16.2354c0 .1230.0088.2451.0264.3652.0107.0576.0605.0996.1191.0996h15.9814c.0644 0 .1230-.0430.1416-.1045l.2402-.7510zm2.7568-5.4844c-.0801 0-.1602.002-.2402.0068a.1358.1358 0 00-.1191.0947l-.3408 1.1748c-.1475.5068-.0908.9736.1553 1.3154.2246.3164.6045.499 1.0615.5205l1.8447.1123c.0547.002.1035.0273.1348.0723.0303.0459.0361.1045.0225.1582-.0264.0938-.1123.1621-.207.1709l-1.9160.1123c-1.0410.0479-2.1592.8877-2.5527 1.9160l-.1387.3594c-.0273.0693.0225.1387.0967.1387h6.5947c.0625 0 .1182-.0400.1367-.1006.1143-.4102.1758-.8408.1758-1.2861 0-2.6572-2.1592-4.8164-4.8164-4.8164z',
  },
  Apple: {
    colour: '#555555',
    path: 'M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.208-1.234-3.234-4.897-.026-3.09 2.52-4.559 2.637-4.637-1.454-2.117-3.676-2.335-4.437-2.376-2.026-.156-3.717 1.104-4.65 1.104zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701',
  },
};
...
/** Inline brand mark. Falls back to nothing when a brand has no registered path. */
const BrandMark: React.FC<{ name: string; className?: string }> = ({ name, className = 'h-6 w-6' }) => {
  const icon = BRAND_ICONS[name];
  if (!icon) return null;
  return (
    <svg viewBox="0 0 24 24" className={className} fill={icon.colour} aria-hidden="true" focusable="false">
      <path d={icon.path} />
    </svg>
  );
};
              ...
              <div className="grid grid-cols-2 gap-px border border-gray-200 bg-gray-200 sm:grid-cols-4">
                {CACHED_PLATFORMS.map((p) => (
                  <div key={p.name} className="group bg-white p-5 transition-colors duration-200 hover:bg-gray-50">
                    <BrandMark name={p.name} className="h-7 w-7" />
                    <div className="mt-3 text-base font-black tracking-[-0.03em] text-ink transition-colors duration-200 group-hover:text-brand-red">
                      {p.name}
                    </div>
