          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Edit Sales and Support contact details</p>
              </div>
            </div>
            <button
              onClick={handleSave}
              ...
              <div className="bg-gradient-to-r from-blue-500/20 to-blue-600/10 px-6 py-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">For new business inquiries and quotes</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="flex items-center gap-2 text-sm text-gray-500 mb-2 font-medium">
              ...
              <div className="bg-gradient-to-r from-green-500/20 to-green-600/10 px-6 py-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">For existing customers needing help</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
