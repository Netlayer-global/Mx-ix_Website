    ...
    <div className="border border-gray-200">
      ...
      <div className="p-5 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-gray-50">
        ...
        <div className="relative">
          ...
          <svg className="w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-gray-100">
            {servers.length > 0 ? (
              ...
              <tr>
                <td colSpan={4} className="py-12 text-center font-mono text-label-sm tracking-mono uppercase text-gray-500">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gray-200 border border-gray-200">
            <div className="bg-white p-5">
              <div className="font-mono text-label-sm tracking-label uppercase text-gray-500">MX-IX Route Server ASN</div>
              <div className="text-xl font-black tracking-tighter text-ink mt-1">AS141539</div>
            </div>
            <div className="bg-white p-5">
              <div className="font-mono text-label-sm tracking-label uppercase text-gray-500">PeeringDB</div>
              <a href="https://www.peeringdb.com/org/43398" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 hover:opacity-70 transition-opacity hover-trigger" aria-label="MX-IX on PeeringDB">
                <img src="/assets/peeringdb-logo.png" alt="PeeringDB" className="h-7 w-auto" loading="lazy" />
              </a>
            </div>
            <div className="bg-white p-5">
              <div className="font-mono text-label-sm tracking-label uppercase text-gray-500">Support Desk</div>
              <a href="mailto:support@mx-ix.com" className="text-lg font-bold tracking-tight text-ink mt-1 inline-block hover:text-[#F20732] transition-colors hover-trigger break-all">support@mx-ix.com</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <aside className="lg:col-span-3">
            <div className="sticky top-28 space-y-1">
              <div className="font-mono text-label-sm tracking-label uppercase text-gray-500 mb-3 px-4">On this page</div>
              {NAV.map((n) => (
                <a
                  key={n.id}
                  href={`#${n.id}`}
          ...
          <div className="lg:col-span-9 space-y-16">
            ...
            <div id="route-servers" className="scroll-mt-28">
              ...
              <RouteServerTable />
              <p className="text-xs text-gray-500 mt-3 font-mono">Select a location to view its route server addresses · click an IP to copy.</p>
            </div>
      ...
      <section className="bg-ink text-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-14 flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-gray-500 mt-2 max-w-xl">Our NOC can help you turn up BGP and get your prefixes filtered correctly.</p>
          </div>
          <button
            onClick={goToContact}
