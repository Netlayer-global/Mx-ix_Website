...
const StatsAdminPanel: React.FC<StatsAdminPanelProps> = ({ embedded = false, onBack }) => {
  const [stats, setStats] = useState<GlobalStatsData>({
    totalCapacity: { value: 3200, unit: 'Gbps' },
    peakTraffic: { value: 985, unit: 'Gbps', trend: 'up', trendValue: '+8.1%' },
    connectedNetworks: { value: 84, unit: 'Peers', trend: 'up', trendValue: '+6' },
    ipv4Prefixes: { value: 62400, unit: 'Routes', trend: 'stable' },
  });
    ...
    <div className="min-h-screen bg-black text-white pt-32 pb-20">
      <div className="max-w-5xl mx-auto px-6">
        <div className="mb-12">
          ...
          <p className=" text-gray-500">Manage global network statistics displayed on the stats page</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-500 mb-2">Value</label>
                <input
                  type="number"
          ...
          <div className="bg-white/5 border border-white/10 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-500 mb-2">Trend</label>
                <select
              ...
              <div>
                <label className="block text-sm text-gray-500 mb-2">Trend Value</label>
                <input
                  type="text"
