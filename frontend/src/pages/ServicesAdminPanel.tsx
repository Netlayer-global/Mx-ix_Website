                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${value === iconName ? 'bg-[#F20732]/20 border border-[#F20732] text-[#F20732]' : 'text-gray-500 hover:text-white border border-transparent'}
                    `}
                    title={iconName}
                  >
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800 rounded-xl p-8 w-full max-w-md border border-gray-700">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Sign in to manage services</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Manage service categories and items</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button
                  ...
                  <div className="p-4 flex items-center justify-between rounded-t-xl">
                    ...
                    <div className="flex items-center gap-2 relative z-10">
                      <button
                        ...
                        className="p-2 text-gray-500 hover:text-white hover:bg-gray-700 rounded transition-all pointer-events-auto"
                        title="Edit"
                        type="button"
                      >
                      ...
                      <button
                        ...
                        className="p-2 text-gray-500 hover:text-red-400 hover:bg-red-500/10 rounded transition-all pointer-events-auto"
                        title="Delete"
                        type="button"
                      >
                              ...
                              {editingItem?.serviceId === service.id && editingItem?.index === index ? (
                                ...
                                <div className="p-4">
                                  <div className="flex items-start gap-4">
                                    <div className="w-8 h-8 bg-gray-600 rounded flex items-center justify-center text-gray-500 text-sm flex-shrink-0">
                                      {index + 1}
                                    </div>
