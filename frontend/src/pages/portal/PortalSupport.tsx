    ...
    return (
      <div>
        <button
          ...
          className="inline-flex items-center gap-2 font-mono text-label-sm tracking-mono uppercase text-gray-500 hover:text-ink transition-colors mb-6 hover-trigger"
        >
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap mb-6">
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="font-mono text-xs text-gray-500">#{active._id.slice(-6)} · {active.category}</span>
            </div>
          </div>
          ...
          {active.messages.map((m, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-mono text-xs text-gray-500">{new Date(m.at).toLocaleString()}</span>
              </div>
        ...
        {active.status !== 'closed' ? (
          ...
          <p className="font-mono text-label-sm tracking-mono uppercase text-gray-500">This ticket is closed.</p>
        )}
      </div>
    );
  }
