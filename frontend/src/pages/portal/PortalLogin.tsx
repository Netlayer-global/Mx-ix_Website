        ...
        {signupDone ? (
          ...
          <>
            ...
            <div className="mt-6 pt-6 border-t border-white/10 text-sm text-gray-500 flex items-center justify-between flex-wrap gap-2">
              ...
              <button
                ...
                className="font-mono text-label-sm tracking-mono uppercase text-gray-500 hover:text-[#F20732] transition-colors hover-trigger"
              >
                Forgot password?
              </button>
            </div>
          ...
          <>
            ...
            <button
              ...
              className="mt-6 inline-flex items-center gap-2 font-mono text-label-sm tracking-mono uppercase text-gray-500 hover:text-white transition-colors hover-trigger"
            >
