    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-white/10 space-y-1">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-2.5 font-mono text-label-sm tracking-mono uppercase text-white hover:text-white transition-colors hover-trigger"
        >
          <ExternalLink className="w-4 h-4" /> System Status
        </button>
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-4 py-2.5 font-mono text-label-sm tracking-mono uppercase text-white hover:text-[#F20732] transition-colors hover-trigger"
        >
          ...
          <div className="px-4 sm:px-6 lg:px-10 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                    ...
                    <div className="absolute right-0 mt-2 w-80 max-h-[28rem] overflow-y-auto bg-white border border-gray-200 shadow-elevated z-40">
                      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 sticky top-0 bg-white">
                        ...
                        {unread > 0 && (
                          <button
                            onClick={markAllRead}
                            className="flex items-center gap-1 font-mono text-label-sm tracking-mono uppercase text-gray-500 hover:text-[#F20732] transition-colors"
                          >
                      ...
                      {notifications.length ? (
                        ...
                        <p className="px-4 py-8 text-center font-mono text-label-sm tracking-mono uppercase text-gray-500">
                          No notifications
                        </p>
                      )}
                    </div>
              ...
              <div className="text-right hidden sm:block">
                ...
                <p className="font-mono text-label-sm tracking-mono uppercase text-gray-500">{user.role}</p>
              </div>
