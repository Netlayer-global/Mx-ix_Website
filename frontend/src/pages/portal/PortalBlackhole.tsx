        ...
        <div className="bg-white border border-gray-200 divide-y divide-gray-100">
          {items.map((b) => (
            <div key={b._id} className="px-5 py-4 flex items-center gap-4">
              ...
              <button onClick={() => toggle(b)} className="font-mono text-label-sm uppercase tracking-mono text-gray-500 hover:text-ink transition-colors hover-trigger">
                {b.active ? 'Withdraw' : 'Re-announce'}
              </button>
              <button onClick={() => remove(b._id)} className="p-1.5 text-gray-500 hover:text-[#F20732] transition-colors">
