    ...
    <div className="min-h-screen bg-black text-white pt-32 pb-20">
      <div className="max-w-5xl mx-auto px-6">
        <div className="mb-12">
          ...
          <p className=" text-gray-500">Manage key statistics displayed on the homepage hero section</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">Number of locations shown on the homepage.</p>
            <div>
              <input
                type="number"
          ...
          <div className="bg-white/5 border border-white/10 p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">Number of active nodes/data centers shown.</p>
            <div>
              <input
                type="number"
          ...
          <div className="bg-white/5 border border-white/10 p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">Total network throughput displayed on the homepage.</p>
            <div>
              <input
                type="number"
                step="0.1"
