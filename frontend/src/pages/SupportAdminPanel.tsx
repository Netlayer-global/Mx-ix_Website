...
const badge = (s: string, kind: 'status' | 'priority') => {
  const status: Record<string, string> = {
    ...
    closed: 'bg-gray-600/20 text-gray-500 border-gray-600/40',
  };
  const priority: Record<string, string> = {
    ...
    low: 'bg-gray-600/20 text-gray-500 border-gray-600/40',
  };
      ...
      <div className="min-h-screen bg-gray-900 text-white admin-panel">
        ...
        <main className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3 bg-gray-800 border border-gray-700 rounded-lg p-4">
            ...
            <label className="text-xs text-gray-500 font-mono uppercase">Priority</label>
        ...
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Member tickets &amp; responses</p>
            </div>
          </div>
          <div className="ml-auto text-right">
            <div className="text-lg font-bold">{openCount}</div>
            <div className="text-[10px] uppercase tracking-wider text-gray-500 font-mono">Open</div>
          </div>
        </div>
      </header>
