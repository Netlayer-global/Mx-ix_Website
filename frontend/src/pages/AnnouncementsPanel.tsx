    ...
    <div className="min-h-screen bg-gray-900 text-white admin-panel">
      <header className="bg-gray-800 border-b border-gray-700 px-6 py-4 sticky top-0 z-20">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-xl font-bold">Announcements</h1><p className="text-gray-500 text-sm">Broadcast to members (in-app + email)</p></div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold text-gray-500">Recent broadcasts</h2>
          {items.map((a) => (
