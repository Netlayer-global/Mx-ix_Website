      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="/services" className="text-gray-500 hover:text-[#F20732] transition-colors text-sm">Services</a>
            <span className="text-gray-700">•</span>
            <a href="/locations" className="text-gray-500 hover:text-[#F20732] transition-colors text-sm">Locations</a>
            <span className="text-gray-700">•</span>
            <a href="/contact" className="text-gray-500 hover:text-[#F20732] transition-colors text-sm">Contact</a>
            <span className="text-gray-700">•</span>
            <a href="/about" className="text-gray-500 hover:text-[#F20732] transition-colors text-sm">About</a>
          </div>
        </div>
      </div>
