  ...
  return (
    <div className="min-h-screen bg-white text-ink">
      ...
      {!loading && !error && services.length > 0 && (
        <section className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-gray-200">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-3 flex items-center gap-2 overflow-x-auto scrollbar-hide">
            <span className="font-mono text-label-sm tracking-label uppercase text-gray-500 mr-2 flex-shrink-0">Jump to</span>
            {services.map((s, i) => (
              <a
                key={s.id}
                href={`#${s.id}`}
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              <div className="lg:col-span-2">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="font-mono text-label-sm tracking-mono uppercase text-gray-500">{service.tagline}</span>
                </div>
                      ...
                      <div className="px-6 md:px-8 pb-8 pt-2">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                          ...
                          {item.benefits?.length > 0 && (
                            <div>
                              <h4 className="font-mono text-label-sm tracking-label uppercase text-gray-500 mb-4 flex items-center gap-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-gray-200 border border-gray-200 mt-8">
                            {item.stats.map((stat, sIdx) => (
                              <div key={sIdx} className="bg-white p-5 text-center">
                                ...
                                <div className="font-mono text-label-sm tracking-label uppercase text-gray-500 mt-1">{stat.label}</div>
      ...
      {!loading && !error && (
        <section className="border-b border-gray-200 bg-white">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-16">
            <span className="eyebrow">Who Connects</span>
      ...
      <section className="bg-ink text-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-14 flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-gray-500 mt-2 max-w-xl">Talk to our team and find the right service for your network.</p>
          </div>
          <button
            onClick={goToContact}
