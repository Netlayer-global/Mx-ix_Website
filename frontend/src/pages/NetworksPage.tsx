      ...
      <section className="relative pt-36 md:pt-44 pb-12 bg-ink text-white overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="eyebrow">Connected Networks</span>
          </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div className="flex gap-3">
                  <div className="px-4 py-2 border border-gray-200">
                    ...
                    <div className="font-mono text-[9px] tracking-label uppercase text-gray-500">Networks</div>
                  </div>
                  <div className="px-4 py-2 border border-[#F20732]/30 bg-[#F20732]/5">
                    ...
                    <div className="font-mono text-[9px] tracking-label uppercase text-gray-500">Total Sessions</div>
                  </div>
                </div>
                      ...
                      {filtered.map((r) => (
                        <tr key={r.asn} className="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 py-3 text-right font-mono text-xs font-bold tabular-nums">
                            <span className={r.established ? 'text-green-600' : 'text-gray-500'}>{r.established}</span>
                          </td>
                        </tr>
                      ))}
                      {!filtered.length && (
                        <tr><td colSpan={5} className="px-4 py-16 text-center font-mono text-xs text-gray-500 uppercase tracking-label">No networks match your filter.</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
