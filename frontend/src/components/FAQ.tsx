    ...
    <section className="relative bg-white py-20 md:py-28 border-b border-gray-200 z-10">
      <div className="max-w-[1000px] mx-auto px-6 md:px-12">
        <Reveal className="mb-12">
          <span className="eyebrow mb-4">Peering 101</span>
            ...
            return (
              <div key={i} className="border-b border-gray-200">
                ...
                >
                  ...
                  {isOpen ? <Minus className="w-5 h-5 text-[#F20732] flex-shrink-0" /> : <Plus className="w-5 h-5 text-gray-500 flex-shrink-0" />}
                </button>
