...
const GlobalFabricMap = () => {
  ...
  return (
    <section className="relative w-full bg-white border-t border-gray-200 py-16 md:py-20 overflow-hidden">
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        {/* Header */}
        <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            <span className="eyebrow">Global Presence</span>
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-ink mt-2">MX-IX Global Map</h2>
          </div>
          <p className="font-mono text-label-sm tracking-label uppercase text-gray-500">{locations.length} active locations worldwide</p>
        </div>
        ...
        <div className="relative bg-white border border-gray-200 overflow-hidden">
          ...
          <div className="absolute top-6 left-6 right-6 flex items-center justify-between z-20">
            <div className="flex items-center gap-4">
              <div className="bg-white/90 backdrop-blur-md border border-gray-200 px-4 py-2 shadow-sm">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                aria-label="Zoom in"
                className="w-10 h-10 bg-white/90 backdrop-blur-md border border-gray-200 flex items-center justify-center text-black hover:border-[#F20732] hover:text-[#F20732] transition-all shadow-sm"
              >
              ...
              return (
                ...
                >
                  <div className="relative">
                    {/* Glow effect */}
                    <div className={`absolute -inset-1 blur-md opacity-50 ${loc.status === 'current' ? 'bg-[#F20732]' : 'bg-gray-400'}`} />
                    
                    {/* Card */}
                    <div className="relative bg-white border-2 border-gray-200 shadow-2xl overflow-hidden w-[200px]">
                      {/* Header */}
                      ...
                      <div className="px-4 py-3 space-y-1.5">
                        ...
                        <div 
                          className="flex justify-between text-[10px] cursor-pointer hover:bg-gray-50 px-1 py-0.5 -mx-1 transition-colors group"
                          onClick={(e) => {
                            e.stopPropagation();
                        ...
                        >
                          ...
                          <span className="text-black font-bold group-hover:text-[#F20732] transition-colors flex items-center gap-1">
                            ...
                            <span className="text-gray-500 group-hover:text-[#F20732]">→</span>
                          </span>
                        </div>
                        ...
                        <button 
                          ...
                          className="w-full mt-2 bg-[#F20732] text-white text-[10px] font-bold uppercase tracking-wider py-2 hover:bg-[#C00628] transition-colors flex items-center justify-center gap-2"
                        >
                          VIEW DETAILS
          ...
          <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="font-mono text-[9px] text-gray-600 tracking-widest uppercase bg-white/60 backdrop-blur-sm px-3 py-1.5 border border-gray-200 shadow-sm">
                PROJECTION: MERCATOR
              </div>
              <div className="font-mono text-[9px] text-gray-600 tracking-widest uppercase bg-white/60 backdrop-blur-sm px-3 py-1.5 border border-gray-200 shadow-sm">
                LAYER: GLOBAL FABRIC
            ...
            <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-3 py-1.5 border border-gray-200 shadow-sm">
